...
public class TestAVLTDigestImplementation {
  
  private TDigest digest;
  
  @Before
  public void before() throws Exception {
    digest = AVLTreeDigest.createDigest(100);
    digest.add(42.5);
    digest.add(1);
    digest.add(24.0);
  }
  ...
  public void ctor() throws Exception {
    ...
    try {
      new AVLTDigestImplementation(-1);
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
    
    try {
      new AVLTDigestImplementation(256);
      fail("Expected IllegalArgumentException");
    } catch (IllegalArgumentException e) { }
  }
...
//  @Test
//  public void AVLTreeDigestSerDes() throws Exception {
//    final TDigest out = AVLTreeDigest.createDigest(100);
//    out.add(42.5);
//    out.add(1);
//    out.add(24.0);
...
//  }
  ...
  public void getClone() throws Exception {
    ...
    final AVLTDigestImplementation copy = 
        (AVLTDigestImplementation) histo.clone();
  ...
  public void aggregate() throws Exception {
    TDigest digest2 = AVLTreeDigest.createDigest(100);
    digest2.add(12);
    digest2.add(89.3);
    digest2.add(15);
    ...
    final AVLTDigestImplementation histo2 = 
        new AVLTDigestImplementation(42);
  ...
  public void aggregateList() throws Exception {
    ...
    TDigest digest3 = AVLTreeDigest.createDigest(100);
    digest3.add(33);
    digest3.add(22.4);
    digest3.add(6.98);
    ...
    final AVLTDigestImplementation histo3 = 
        new AVLTDigestImplementation(42);
